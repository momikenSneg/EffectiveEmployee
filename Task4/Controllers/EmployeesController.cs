    ...
    public class EmployeesController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            var employees = _context.Employees//.Include(e => e.Projects)
                .Select(e => new ViewEmployee(e)
                {
                    PremiumSum = e.Projects.Sum(p => p.Premium)
                })
            //.GroupBy(e => e.FullName)
            .OrderByDescending(e => e.PremiumSum)
            .ToListAsync();
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("EmployeeId,FullName,Age")] Employee employee)
        {
        ...
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> DeleteProject(int id, int employeeId)
        {
